...
class PolymorphismTest {
    ...
    fun `verify chip_group parsing`() {
        ...
        assertTrue("Expected children to be parsed", component.children?.size == 1)
        assertTrue("Expected child to be Chip", component.children?.first() is ComponentModel.Chip)
    }
}
